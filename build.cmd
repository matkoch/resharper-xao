...
%nuget% pack "src\plugin.R90.nuspec" -NoPackageAnalysis -Version %version% -Properties "Configuration=%config%;ReSharperDep=Wave;ReSharperVer=[1.0];PackageId=%package_id%.R90"